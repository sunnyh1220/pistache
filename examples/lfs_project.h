...
static int lfs_project_list(const char *pathname,
		     struct project_handle_control *phc);
static int lfs_project_check(const char *pathname,
		      struct project_handle_control *phc);
static int lfs_project_clear(const char *pathname,
		      struct project_handle_control *phc);
static int lfs_project_set(const char *pathname,
		    struct project_handle_control *phc);
